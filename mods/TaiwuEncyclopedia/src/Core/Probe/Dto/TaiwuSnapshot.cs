...
public sealed class TaiwuSnapshot
{
    // 画像层
    ...
    // 内力层
    [JsonProperty("内力类型值")] public int NeiliTypeRaw { get; set; }
    [JsonProperty("内力类型")] public string? NeiliTypeName { get; set; }
    [JsonProperty("五行索引")] public int FiveElementIndex { get; set; }
    [JsonProperty("五行")] public string? FiveElementName { get; set; }
    [JsonProperty("内力五行占比")] public int[] FiveElementsProportion { get; set; } = new int[5];
    ...
    [JsonProperty("资源名")] public string[]? ResourceKeys { get; set; }
    // 资质层
    ...
    // 运功装备
    [JsonProperty("装备功法")] public string? EquippedCombatSkillsText { get; set; }
    [JsonProperty("装备")] public string? EquipmentText { get; set; }
    // 错误
